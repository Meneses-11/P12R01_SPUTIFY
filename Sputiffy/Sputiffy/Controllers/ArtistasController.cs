...
namespace Sputiffy.Controllers
{
    public class ArtistasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdArtista,NombreArtistico,PaisOrigen,FechaDebut,FotoUrl,Activo")] Artistas artistas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdArtista,NombreArtistico,PaisOrigen,FechaDebut,FotoUrl,Activo")] Artistas artistas)
        {
            if (ModelState.IsValid)
            {
